          ...
          <div className="flex items-center justify-between bg-[#202c33] py-2 pl-3">
            ...
            <div className="icons flex  items-center w-2/5 ">
              <div className="flex justify-between w-full items-center ">
                ...
                <div className="icon text-base text-slate-400  w-[20px] ml-2">
                  <svg
                    viewBox="0 0 24 24"
                    preserveAspectRatio="xMidYMid meet"
                    version="1.1"
                ...
                <div className="icon text-base text-slate-400  w-7 p-1 hover:bg-slate-700/[0.6] active:bg-slate-700/[0.6] rounded-full mx-2">
                  <svg
                    viewBox="0 0 24 24"
                    preserveAspectRatio="xMidYMid meet"
                    version="1.1"
