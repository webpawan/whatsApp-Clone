  ...
  return (
    <>
      <div className="flex h-screen bg-[rgb(17,27,33)] p-4">
        <div className=" basis-[355px]  border-r border-r-slate-700 ">
          <div className="flex items-center justify-between bg-[#202c33] py-2 px-3 ">
            ...
            <div className="icons flex justify-between items-center w-2/5 mr-2">
              ...
              <div className="icon text-base text-slate-400  w-[20px]">
                <svg
                  viewBox="0 0 24 24"
                  preserveAspectRatio="xMidYMid meet"
                  version="1.1"
              ...
              <div className="icon text-base text-slate-400">
